# Stars block
Replace `polosanya` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://polosanya.github.io/layout_stars/)
- [TEST REPORT LINK](https://polosanya.github.io/layout_stars/report/html_report/)
