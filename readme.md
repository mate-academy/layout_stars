# Stars block
Replace `<vadosik15>` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://vadosik15.github.io/layout_stars/)
- [TEST REPORT LINK](https://vadosik15.github.io/layout_stars/report/html_report/)
