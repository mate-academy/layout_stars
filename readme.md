...
- [DEMO LINK](https://korniienkokarina.github.io/layout_stars/)
- [TEST REPORT LINK](https://korniienkokarina.github.io/layout_stars/report/htmnpml_report/)
...
- Each star in a block should have a class `stars--star` and no extra classes or inline styles
