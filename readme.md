...
❗️ Replaced `<your_account>` with my GitHub username, `mcspidy`, and copied the links to the `Pull Request` description:

- [DEMO LINK](https://mcspidy.github.io/layout_stars/)
- [TEST REPORT LINK](https://mcspidy.github.io/layout_stars/report/html_report/)
