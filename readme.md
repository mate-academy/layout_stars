# Stars block
Replace `Andrii-OttO` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://Andrii-OttO.github.io/layout_stars/)
- [TEST REPORT LINK](https://Andrii-OttO.github.io/layout_stars/report/html_report/)
