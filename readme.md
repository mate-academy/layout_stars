...
- [DEMO LINK](https://DidZhara.github.io/layout_stars/)
- [TEST REPORT LINK](https://DidZhara.github.io/layout_stars/report/html_report/)

❗️ Copy this `Checklist` to the `Pull Request` description after links, and put `- []` before each point after you checked it.
