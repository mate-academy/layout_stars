# Stars block
Replace `iLavruk` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://iLavruk.github.io/layout_stars/)
- [TEST REPORT LINK](https://iLavruk.github.io/layout_stars/report/html_report/)
