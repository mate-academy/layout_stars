# Stars block
Replace `YuriMoreau` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://YuriMoreau.github.io/layout_stars/)
- [TEST REPORT LINK](https://YuriMoreau.github.io/layout_stars/report/html_report/)
