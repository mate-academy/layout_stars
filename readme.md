# Stars block
Replace `my_account` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://okokaylo.github.io/layout_stars/)
- [TEST REPORT LINK](https://okokaylo.github.io/layout_stars/report/html_report/)
