# Stars block
Replace `bormaxvel` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://bormaxvel.github.io/layout_stars/)
- [TEST REPORT LINK](https://bormaxvel.github.io/layout_stars/report/html_report/)
