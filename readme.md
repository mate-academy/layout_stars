...
❗️ Replace `fabiocosta123` with your Github username and copy the links to `Pull Request` description:

- [DEMO LINK](https://fabiocosta123.github.io/layout_stars/)
- [TEST REPORT LINK](https://fabiocosta123.github.io/layout_stars/report/html_report/)
