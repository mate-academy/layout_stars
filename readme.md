# Stars block
Replace `SichVictor` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://SichVictor.github.io/layout_stars/)
- [TEST REPORT LINK](https://SichVictor.github.io/layout_stars/report/html_report/)
