...
- [DEMO LINK](https://santana1337.github.io/layout_stars/)
- [TEST REPORT LINK](https://santana1337.github.io/layout_stars/report/html_report/)

❗️ Copy this `Checklist` to the `santana1337` description after links, and put `- [x]` before each point after you checked it.
