# Stars block
Replace `Denisdkoval` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://Denisdkoval.github.io/layout_stars/)
- [TEST REPORT LINK](https://Denisdkoval.github.io/layout_stars/report/html_report/)
