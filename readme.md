# Stars block
Replace `vivdyuk` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://vivdyuk.github.io/layout_stars/)
- [TEST REPORT LINK](https://vivdyuk.github.io/layout_stars/report/html_report/)
