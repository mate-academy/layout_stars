# Stars block
Replace `<illyamyhalyk>` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://<illyamyhalyk>.github.io/layout_stars/)
- [TEST REPORT LINK](https://<illyamyhalyk>.github.io/layout_stars/report/html_report/)
