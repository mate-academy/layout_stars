...
- use `background-image` for stars (see `images` folder). Don't use `<div>` or `<svg>` tags.
...
- [DEMO LINK](https://PODDN.github.io/layout_stars/)
- [TEST REPORT LINK](https://PODDN.github.io/layout_stars/report/html_report/)
