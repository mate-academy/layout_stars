...
- [DEMO LINK](https://Artur2912.github.io/layout_stars/)
- [TEST REPORT LINK](https://Artur2912.github.io/layout_stars/report/html_report/)
Artur2912his `Checklist` to the `Pull Request` description after links, and put `- [x]` before each point after you checked it.
