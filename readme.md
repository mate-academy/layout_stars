...
1. Replace `<your_account>` with your Github username in the links
    - [DEMO LINK](https://dima-bond.github.io/layout_stars/) <br>
    - [TEST REPORT LINK](https://dima-bond.github.io/layout_stars/report/html_report/)
...
- Implement 6 `stars` blocks
  ...
  - Add 5 more blocks with a modifier per block from `block__stars--1` to `block__stars--5`
